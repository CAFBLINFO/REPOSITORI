                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Gestió de Comunitats</h4><br>
                                    <h5><strong>Col·legiat: <%=request("codcol")%> (<%=txt_user_name%>)</strong></h5>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=rsCliCol("nif_cli")%></td>

                                                        <td align="center">
                                                            <a href="javascript:$('#modal-6').modal('show', {backdrop: 'statuc'});" onClick="setNIF('<%=trim(rsCliCol("nif_cli"))%>','<%=trim(rsCliCol("cod_col"))%>','<%=trim(rsCliCol("id_cert"))%>')"><%=trim(rsCliCol("id_cert"))%></a>
                                                        </td>                                
